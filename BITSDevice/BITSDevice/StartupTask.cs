...
namespace BITSDevice
{
    public sealed class STOP_INFORMATION 
    {
        ...
        static int LINE_ID = 10;        //route from Attaba to Zamalek
        ...
        static int DIRECTION_FORWARD    = 1 ;    //Forward from Abasia to Tahrier
        static int DIRECTION_BACKWORD   = -1;    //backword from Tahrier to Abasia 
